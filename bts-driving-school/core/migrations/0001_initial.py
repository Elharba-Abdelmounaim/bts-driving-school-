# Generated by Django 5.0.7 on 2025-09-01 22:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('car', 'Car'), ('moto', 'Motorcycle'), ('truck', 'Truck'), ('bus', 'Bus')], max_length=20)),
                ('category', models.CharField(choices=[('AM', 'AM'), ('A1', 'A1'), ('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('EB', 'EB'), ('EC', 'EC'), ('ED', 'ED')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_types', models.ManyToManyField(blank=True, to='core.licensecategory')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('license_category', models.CharField(choices=[('AM', 'AM'), ('A1', 'A1'), ('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('EB', 'EB'), ('EC', 'EC'), ('ED', 'ED')], max_length=3)),
